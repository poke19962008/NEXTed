			...
			<div id="grid-gallery" class="grid-gallery">
				<section class="grid-wrap">
					<ul class="grid">
						...
						<li>
							<figure>
								<img src="img/ips/1.jpg" alt="img01"/>
								<figcaption><h3 class="newhead">Letterpress asymmetrical</h3><p>Chillwave hoodie ea gentrify aute sriracha consequat.</p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="img/ips/2.jpg" alt="img02"/>
								<figcaption><h3 class="newhead">Vice velit chia</h3><p>Laborum tattooed iPhone, Schlitz irure nulla Tonx retro 90's chia cardigan quis asymmetrical paleo. </p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="img/ips/3.jpg" alt="img03"/>
								<figcaption><h3 class="newhead">Brunch semiotics</h3><p>Ex disrupt cray yr, butcher pour-over magna umami kitsch before they sold out commodo.</p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="img/ips/4.jpg" alt="img04"/>
								<figcaption><h3 class="newhead">Chillwave nihil occupy</h3><p>In post-ironic gluten-free deserunt, PBR&amp;B non pork belly cupidatat polaroid. </p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="img/ips/5.jpg" alt="img05"/>
								<figcaption><h3 class="newhead">Kale chips lomo biodiesel</h3><p>Pariatur food truck street art consequat sustainable, et kogi beard qui paleo. </p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="img/ips/6.jpg" alt="img06"/>
								<figcaption><h3 class="newhead">Exercitation occaecat</h3><p>Street chillwave hoodie ea gentrify.</p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="img/ips/1.jpg" alt="img01"/>
								<figcaption><h3 class="newhead">Selfies viral four</h3><p>Raw denim duis Tonx Shoreditch labore swag artisan High Life cred, stumptown Schlitz quinoa flexitarian mollit fanny pack.</p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="img/ips/2.jpg" alt="img02"/>
								<figcaption><h3 class="newhead">Photo booth skateboard</h3><p>Vinyl squid ex High Life. Paleo Neutra nulla master cleanse, Helvetica et enim nesciunt esse.</p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="img/ips/3.jpg" alt="img03"/>
								<figcaption><h3 class="newhead">Ex fashion axe</h3><p>Qui nesciunt et, in chia cliche irure. Eu YOLO nihil mollit twee locavore, tempor keytar asymmetrical irure aute sriracha consequat.</p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="img/ips/4.jpg" alt="img04"/>
								<figcaption><h3 class="newhead">Thundercats next level</h3><p>Portland nulla butcher ea XOXO, consequat Bushwick Pinterest elit twee pickled direct trade vero. </p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="img/ips/5.jpg" alt="img05"/>
								<figcaption><h3 class="newhead">Bushwick selvage synth</h3><p>Bicycle rights flannel Shoreditch, art party laboris Bushwick sriracha authentic chambray hella umami sed distillery master cleanse.</p></figcaption>
							</figure>
						</li>
						<li>
							<figure>
								<img src="img/ips/1.jpg" alt="img01"/>
								<figcaption><h3 class="newhead">Bottle wayfarers locavore</h3><p>Once there was a little asparagus, he was green and lonely.</p></figcaption>
							</figure>
						</li>	
						<li>
							<figure>
				...
				<section class="slideshow">
					<ul>
						<li>
							<figure>
								<figcaption>
									<h3 class="newhead">Letterpress asymmetrical</h3>
						...
						<li>
							<figure>
								<figcaption>
									<h3 class="newhead">Vice velit chia</h3>
						...
						<li>
							<figure>
								<figcaption>
									<h3 class="newhead">Brunch semiotics</h3>
						...
						<li>
							<figure>
								<figcaption>
									<h3 class="newhead">Chillwave nihil occupy</h3>
						...
						<li>
							<figure>
								<figcaption>
									<h3 class="newhead">Kale chips lomo biodiesel</h3>
						...
						<li>
							<figure>
								<figcaption>
									<h3 class="newhead">Exercitation occaecat</h3>
						...
						<li>
							<figure>
								<figcaption>
									<h3 class="newhead">Selfies viral four</h3>
						...
						<li>
							<figure>
								<figcaption>
									<h3 class="newhead">Photo booth skateboard</h3>
						...
						<li>
							<figure>
								<figcaption>
									<h3 class="newhead">Ex fashion axe</h3>
						...
						<li>
							<figure>
								<figcaption>
									<h3 class="newhead">Thundercats next level</h3>
						...
						<li>
							<figure>
								<figcaption>
									<h3 class="newhead">Bushwick selvage synth</h3>
						...
						<li>
							<figure>
								<figcaption>
									<h3 class="newhead">Bottle wayfarers locavore</h3>
